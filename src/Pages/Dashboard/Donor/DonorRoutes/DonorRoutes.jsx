...
const DonorRoutes = () => {
    return(
        <div className="uppercase flex flex-col gap-3   " >
               ...
               <NavLink to='/dashboard/my-donation-requests' className={({isActive})=>`${isActive&&` bg-green-600 text-white `} py-2 px-3 text-center rounded-md font-bold shadow-md  `}>my donation request</NavLink>
